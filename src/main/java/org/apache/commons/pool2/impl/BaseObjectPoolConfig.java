...
public abstract class BaseObjectPoolConfig implements Cloneable {
  ...
  /**至少空闲这么多时间才有资格被evict线程淘汰.-1表示永远不会被淘汰,除非validate未通过等
  ...
  /**在DEFAULT_MIN_EVICTABLE_IDLE_TIME_MILLIS的基础上,额外附加了个条件：要求至少有minIdle的对象空闲才行。
